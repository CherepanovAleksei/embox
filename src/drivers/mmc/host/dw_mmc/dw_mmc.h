...
#define mci_fifo_readw(__reg)     REG16_STORE(__reg)
#define mci_fifo_readl(__reg)     REG32_STORE(__reg)
#define mci_fifo_readq(__reg)     REG64_STORE(__reg)

#define mci_fifo_writew(__value, __reg)     REG16_STORE(__reg, __value)
#define mci_fifo_writel(__value, __reg)     REG32_STORE(__reg, __value)
#define mci_fifo_writeq(__value, __reg)     REG64_STORE(__reg, __value)
#endif
